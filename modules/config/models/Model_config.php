...
class Model_config extends MY_Model {
    ...
    private $primary_key    = 'id_config';
    private $table_name     = 'config';
    public $field_search   = ['kode', 'config_name', 'variable', 'value', 'is_active', 'owner', 'keterangan'];
    public $sort_option = ['id_config', 'DESC'];
