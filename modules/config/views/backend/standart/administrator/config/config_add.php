...
<section class="content-header">
    <h1>
        Config        <small><?= cclang('new', ['Config']); ?> </small>
    </h1>
    <ol class="breadcrumb">
...
<section class="content">
                ...
                <div class="box-body ">
                    <div class="box box-widget widget-user-2">
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Config']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            'name' => 'form_config_add',
    ...
    <div class="form-group group-config_name ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="config_name" id="config_name" placeholder="Config Name" value="<?= set_value('config_name'); ?>">
                                <small class="info help-block">
    ...
    <div class="form-group group-variable ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="variable" id="variable" placeholder="Variable" value="<?= set_value('variable'); ?>">
                                <small class="info help-block">
    ...
    <div class="form-group group-is_active ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="is_active" id="is_active" placeholder="Is Active" value="<?= set_value('is_active'); ?>">
                                <small class="info help-block">
    ...
    <div class="form-group group-owner ">
...
<script>
    ...
    var form_config = $('#form_config_add');
    ...
    $.ajax({
            url: ADMIN_BASE_URL + '/config/add_save',
            type: 'POST',
            dataType: 'json',
            data: data_post,
        })
