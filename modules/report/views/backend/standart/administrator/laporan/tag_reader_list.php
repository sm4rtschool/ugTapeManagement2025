                ...
                <div class="box box-widget widget-user-2">
                   ...
                   <div class="row">
                      <div class="col-md-12">
                         ...
                         <div class="col-sm-1 padd-left-0  ">
                            <button class="btn btn-danger" class="html2PdfConverter" onclick="createPDF()">Download PDF <i class="fa fa-file-pdf-o"></i></button>
                         </div>
                      </div>
                      <div class="col-md-4">
 ...
 <script>
    ...
    function createPDF() {
       const selectedID = $("#jenlap").val();

       if (selectedID == '') {
          alert('Harap pilih salah satu jenis laporan!');
 ...
 <script>
    ...
    function getTransaksi() {
       //  e.preventDefault();
       // Ambil nilai ID yang dipilih
       const tipetransaksi = $("#pilihtransaksi").val(); // Ambil nilai ID yang dipilih
    ...
    $("#btnload").click(function(e) {
       ...
       var transaksi = document.getElementById('pilihtransaksi');
       ...
       if (selectedID == 1) {
          ...
          if (laporan.value === '' || transaksi.value === '') { //validasi pilihan ruangan dan jenis laporan
             alert('Harap pilih salah satu opsi transaksi dan jenis laporan!');
             e.preventDefault(); // Mencegah pengiriman formulir
          } else {
             getTransaksi();
          }
