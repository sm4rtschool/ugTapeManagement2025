...
<script type="text/javascript">
    ...
    function get_single_tag(tid) {
        return new Promise((resolve, reject) => {
            $.ajax({
                url: ADMIN_BASE_URL + '/pencarian_single_tag/get_single_tag',
                type: 'GET',
                dataType: 'json',
                data: {
                    tid: tid
...
<section class="content-header">
    <h1>
        Pencarian Single Tag<small><?= cclang('new', ['Pencarian Single Tag']); ?></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class=""><a href="<?= admin_site_url('/pencarian_single_tag'); ?>">Pencarian Single Tag</a></li>
                            ...
                            <table class="table table-bordered table-striped dataTable" id="your_table_id">
                                <thead>
                                    <tr class="">
                                        ...
                                        <th style="text-align: center" data-field="id_aset" data-sort="1" data-primary-key="0"> <?= cclang('ID') ?></th>
                                        <th style="text-align: center" data-field="nama_aset" data-sort="1" data-primary-key="0"> <?= cclang('Nama') ?></th>
                                        <th style="text-align: center" data-field="kode_aset" data-sort="1" data-primary-key="0"> <?= cclang('Kode') ?></th>
                                        ...
                                        <th style="text-align: center" data-field="kode_tid" data-sort="1" data-primary-key="0"> <?= cclang('Kategori Tag') ?></th>
                                        <th style="text-align: center" data-field="hasil_pencarian" data-sort="1" data-primary-key="0"> <?= cclang('Hasil Pencarian') ?></th>
                                        <th style="text-align: center" data-field="ruangan" data-sort="1" data-primary-key="0"> <?= cclang('Ruangan') ?></th>
                    ...
                    if (metode_pencarian == 'bulk') {
                        ...
                        try {
                            ...
                            if (!tidCountForPartial[tid]) {
                                ...
                                get_single_tag(tid).then(async function(response) {

                                    is_unique_single_tag = response.check;
                                    status_tag = response.status_tag;
                                    kategori_tag = response.kategori_tag;
                                    data_aset = response.data_aset;
                                    data_pegawai = response.data_pegawai;
                                            ...
                                            await new Promise(resolve => {
                                                $('#your_table_id tbody').append(`
                                                    <tr>    
                                                        ...
                                                        <td id="asset_foreign_tag_${noUrutData}" style="text-align: center; background-color: #FF0000">Tag Not Used</td>
                                                        <td id="${noUrutData}" style="text-align: center">-</td>
                                                        <td style="text-align: center">
                                                            <i class="ui-tooltip fa fa-trash-o" title="Hapus Data" style="font-size: 22px; cursor:pointer;" data-original-title="Hapus Data" onclick="removeRowBulk(this, '${tid}')"></i>
                                                        </td>
                                                    </tr>
                                        ...
                                        await new Promise(resolve => {
                                            $('#your_table_id tbody').append(`
                                                <tr>    
                                                    ...
                                                    <td id="asset_tid_${tid}" style="text-align: center">${tid}</td>
                                                    <td id="asset_tid_${tid}" style="text-align: center">-</td>
                                                    <td id="asset_foreign_tag_${noUrutData}" style="text-align: center; background-color: #FF0000">Unidentified Tag</td>
                                                    <td id="${noUrutData}" style="text-align: center">-</td>
                                                    <td style="text-align: center">
                                                        <i class="ui-tooltip fa fa-trash-o" title="Hapus Data" style="font-size: 22px; cursor:pointer;" data-original-title="Hapus Data" onclick="removeRowBulk(this, '${tid}')"></i>
                                                    </td>
