<script type="text/javascript">
   function domo() {
      ...
      $('*').bind('keydown', 'Ctrl+a', function() {
         window.location.href = ADMIN_BASE_URL + '/tb_master_ruangan/add';
         return false;
      });
...
<section class="content-header">
   <h1>
      <?= cclang('Master Data Ruangan') ?><small><?= cclang('list_all'); ?></small>
   </h1>
   <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active"><?= cclang('Master Data Ruangan') ?></li>
   </ol>
</section>
<!-- Main content -->
                  ...
                  <div class="widget-user-header ">
                     <div class="row pull-right">
                        <?php is_allowed('tb_room_master_add', function () { ?>
                           <a class="btn btn-flat btn-success btn_add_new" id="btn_add_new" title="<?= cclang('add_new_button', [cclang('Master Ruangan')]); ?>  (Ctrl+a)" href="<?= admin_site_url('/tb_master_ruangan/add'); ?>"><i class="fa fa-plus-square-o"></i> <?= cclang('add_new_button', [cclang('Ruangan')]); ?></a>
                        <?php }) ?>
                     ...
                     <!-- /.widget-user-image -->
                     <h3 class="widget-user-username"><?= cclang('Master Data Ruangan') ?></h3>
                     <h5 class="widget-user-desc"><?= cclang('list_all', [cclang('Master Data Ruangan')]); ?> <i class="label bg-yellow"><span class="total-rows"><?= $tb_room_master_counts; ?></span> <?= cclang('items'); ?></i></h5>
                  </div>
